...
/** Find the model key with the lowest overall average TTFT */
...
export default function TTFTChart({ results }: TTFTChartProps) {
    ...
    return regions.map((region) => {
      ...
      results
        ...
        .forEach((r) => {
          ...
          entry[key] = Math.round(r.avg_ttft_ms);
        });
      return entry;
    });
  ...
  return (
    <ChartCard title="Average TTFT by Region">
